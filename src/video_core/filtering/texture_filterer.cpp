...
void Filtering::filterTexture(Pica::Texture::TextureInfo tex_info, unsigned int* fromBuffer,
	unsigned int* toBuffer)
{
	...
	case Filtering::FilteringTypes::XBRZ:
		if (tex_info.format == Pica::TexturingRegs::TextureFormat::RGB8) {
...
int Filtering::getScaledTextureSize(Pica::TexturingRegs::TextureFormat format, int width, int height) {
